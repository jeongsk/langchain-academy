...
updated: 2025-10-12 12:10:18
---
> 원문: https://langchain-ai.github.io/langgraph/how-tos/multi_agent/

단일 에이전트는 여러 도메인을 전문화하거나 많은 도구를 관리해야 할 때 어려움을 겪을 수 있습니다. 이를 해결하기 위해 에이전트를 더 작고 독립적인 에이전트로 분리하여 [멀티 에이전트 시스템](멀티%20에이전트/멀티%20에이전트%20시스템.md)으로 구성할 수 있습니다.
...
멀티 에이전트 시스템 구축을 시작하려면 가장 인기 있는 두 가지 멀티 에이전트 아키텍처인 [슈퍼바이저](멀티%20에이전트/멀티%20에이전트%20구현.md#슈퍼바이저)와 [스웜](멀티%20에이전트/멀티%20에이전트%20구현.md#스웜swarm)의 LangGraph [미리 빌드된 구현](#미리-빌드된-구현)을 확인하세요.
...
- [멀티 에이전트 시스템 개념](멀티%20에이전트/멀티%20에이전트%20시스템.md)
