...
updated: 2025-10-15 00:32:00
---
# (번역) AI 에이전트를 위한 효과적인 컨텍스트 엔지니어링

> 원문: <https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents>

이 문서는 [[프롬프트 엔지니어링/index|프롬프트 엔지니어링]]의 일부이며, [[프롬프트 엔지니어링/(번역) 컨텍스트 엔지니어링의 부상|컨텍스트 엔지니어링의 부상]] 글과 함께 읽으면 좋습니다.
