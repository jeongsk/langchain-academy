...
The data plane "listener" application periodically calls [control plane APIs](langgraph_control_plane.md#control-plane-api) to:
...
!!! info "Only for Cloud SaaS"
    Data regions are only applicable for [Cloud SaaS](langgraph_cloud.md) deployments.
...
[`Production` type](langgraph_control_plane.md#deployment-types) deployments automatically scale up to 10 containers. Scaling is based on 3 metrics:
...
!!! info "Only for Cloud SaaS"
Static IP addresses are only available for [Cloud SaaS](langgraph_cloud.md) deployments.
...
!!! info
Custom Postgres instances are only available for [Self-Hosted Data Plane](langgraph_self_hosted_data_plane.md) and [Self-Hosted Control Plane](langgraph_self_hosted_control_plane.md) deployments.
...
!!! info
Custom Redis instances are only available for [Self-Hosted Data Plane](langgraph_self_hosted_control_plane.md) and [Self-Hosted Control Plane](langgraph_self_hosted_control_plane.md) deployments.
